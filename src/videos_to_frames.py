        ...
        if success:
            ...
            if VIDEO_TYPE == "rage":
                frame_name = os.path.join(
                    output_folder, f"rage_{current_frame_label:04d}.jpg")
            elif VIDEO_TYPE == "non_rage":
                frame_name = os.path.join(
                    output_folder, f"non_rage_{current_frame_label:04d}.jpg")
...
if __name__ == "__main__":
    ...
    if VIDEO_TYPE == "rage":
        ...
        video_files = [
            f"./MMZ_data/non_rage/non_rage_{i}.mov" for i in range(1, 21)]
